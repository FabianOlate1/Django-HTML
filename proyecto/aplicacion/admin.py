...
from aplicacion.models import carrito, det_pedido, estado_pedido, pedidos, persona, producto

# Register your models here.
class admpersona(admin.ModelAdmin):
    list_display=["rut", "nombre", "apellido", "correo", "direccion", "nombre_usuario"]
    list_editable=["nombre", "apellido", "correo", "nombre_usuario"]
